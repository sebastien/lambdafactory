...
extend.print=	function(args){
		...
		if ( (((typeof(console) == 'undefined') && (typeof(extend.print) === 'undefined')) && (PrintCallback === undefined)) )
		{
			return null
		}
		var res='';
...
extend.init=	function(){
		var __this__=extend;
		String.__len__ = function(){
			return this.length
		};
		Array.extend = function(array){
		};
		...
		Array.__iter__ = function(){
			return this.length
		};
		Array.__len__ = function(){
			return this.length
		};
		...
		Object.hasKey = function(key){
		};
		Object.get = function(key){
		};
		Object.set = function(key, value){
		};
		Object.setDefault = function(key, value){
		};

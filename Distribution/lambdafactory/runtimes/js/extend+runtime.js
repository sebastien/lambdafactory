...
function _meta_(v,m){var ms=v['__meta__']||{};for(var k in m){v[k]=m[k]};v['__meta__']=ms;return v}
var Extend={}
...
Extend.invoke=	_meta_(function(f, arguments){
		var __this__=Extend;
		arguments = Extend.sliceArguments(arguments,1)
		var meta=f["__meta__"];
		var new_arguments=f;
	},	{
			arity:2,
			arguments:[{'name': 'f'}, {'flags': '*', 'name': 'arguments'}]
		})
